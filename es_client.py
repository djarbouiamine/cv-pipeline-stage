    ...
    try:
        ...
        class DummyES:
            ...
            def search(self, *args, **kwargs):
                # Structure minimale attendue par le dashboard ET le chatbot
                return {
                    "hits": {"total": {"value": 0, "relation": "eq"}, "hits": []},
                    "aggregations": {
                        "by_categ": {"buckets": []},
                        "avg_years": {"value": 0},
                        "global_avg": {"value": None},
                        "global_max": {"value": None},
                        "global_min": {"value": None},
                        "avg_experience": {"value": None},
                        "exp_histogram": {"buckets": []},
                        "top_technologies": {"buckets": []},
                        "top_langages": {"buckets": []},
                        "categories": {"buckets": []},
                        "vals": {"buckets": []},
                        "extremum": {"value": None},
                    }
