...
CV_PATTERNS = [
    ...
    r"\bazure expert\b",
    r"\bgcp expert\b",
    r"\bstrongest candidate\b",
    r"\bbest suited\b",
    r"\bsatisfy (?:all )?(?:three |\d+ )?requirements?\b",
    r"\bsatisfies? all\b",
    r"\bexplicitly mention\b",
    r"\brank.*by experience\b",
    r"\bmandatory\b.*\bskill\b",
    r"\boptional\b.*\bskill\b",
    r"\bexclude.*without\b",
    r"\bjunior developer\b",
    r"\bsenior developer\b",
    r"\bmore than\b.*\byears?\b.*\bexperience\b",
    r"\bless than\b.*\byears?\b.*\bexperience\b",
]
