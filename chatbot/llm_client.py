        ...
        if self.provider == "gemini":
            try:
                ...
                try:
                    ...
                    raise ImportError("Aucun SDK Google AI trouvé. Installez google-generativeai ou google-genai.")
            ...
            if _gemini_new_sdk:
                # google-genai (nouveau SDK)
                from google.genai import types
                contents = []
                for m in conv_parts:
                    role = "user" if m["role"] == "user" else "model"
                    contents.append(types.Content(role=role, parts=[m["content"]]))
                ...
                # google-generativeai (ancien SDK)
