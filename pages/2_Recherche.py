...
st.set_page_config(page_title="🔎 Recherche avancée", layout="wide")
st.title("🔎 Recherche avancée de CVs")
st.caption("Filtrage multi-critères, tri et pagination des CVs indexés dans Elasticsearch.")
